...
// Define the User Schema [cite: 218]
const userSchema = new mongoose.Schema({
    ...
    hash: String, // Stores the encrypted password [cite: 218, 219]
    salt: String  // Stores the salt used for encryption [cite: 218, 219]
});
...
userSchema.methods.generateJWT = function() { 
    return jwt.sign( 
    { // Payload for our JSON Web Token [cite: 242, 247]
        _id: this._id, 
        email: this.email, 
        name: this.name, 
    },  
